...
import { ArrowLeft, ShieldCheck, Sparkles, CheckCircle2, Lock } from "lucide-react";
      ...
      <main className="flex-1 pt-24 pb-16">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center gap-2 text-xs text-muted-foreground pb-4">
            ...
            <span>/</span>
            <span className="text-secondary font-semibold">Credential Verifier Sandbox</span>
          </div>
          ...
          <div className="p-8 rounded-3xl bg-card/80 backdrop-blur-md border border-border/80 shadow-lg space-y-4">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-secondary/15 border border-secondary/30 text-secondary text-xs font-bold uppercase tracking-wider">
              ...
              <span>NCISM Cryptographic Attestation Sandbox</span>
            </div>
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-foreground tracking-tight">
              Instant Merkle-Proof{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-secondary via-accent to-primary">
                Ayush Passport Verifier
              </span>
            </h1>
            <p className="text-sm sm:text-base text-muted-foreground max-w-3xl leading-relaxed">
              Verify student competency credentials, verified clinical procedures, institutional seals, and NCISM registration numbers in real-time with zero-knowledge tamper-evident cryptographic proofs.
            </p>
          </div>
        </div>

        {/* Live Verifier Component */}
